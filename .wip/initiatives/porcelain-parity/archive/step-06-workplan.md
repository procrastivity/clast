...
## Outcome (all 5 chunks shipped 2026-07-12)

- Chunk 1 — commit `edadd295` — docs/guides/run-without-claude-code.md
- Chunk 2 — commit `b12ebc0c` — docs/reference/config.md
- Chunk 3 — commit `664552a` — docs/guides/automate-with-cron.md + examples/cron/crontab.sample
- Chunk 4 — commit `a85e662` — docs/guides/automate-with-systemd.md (prose-only placement, stated in commit body)
- Chunk 5 — commit `88f82c3c` — examples/config/config.toml.sample

All Definition-of-done bullets verified true at ship time (see archived step-06-context.md for the full verification trail). No open questions were escalated; all three carried their stated leans through to landing.
