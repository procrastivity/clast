...
| **Entry** | A curated journal entry. Markdown with YAML frontmatter. Lives in `~/.claude/journal/entries/`. Written by `/day-wakeup` via `clast entries write`. See [`reference/entry-frontmatter.md`](../reference/entry-frontmatter.md). |
