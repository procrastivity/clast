...
import (
	...
	rootassets "github.com/procrastivity/clast/assets"
)

// appName names both the XDG config subdirectory and the installed share
// subtree: $XDG_CONFIG_HOME/clast and <prefix>/share/clast/assets.
const appName = "clast"

// executable is os.Executable, indirected so tests can point default-dir
// resolution at a fake <prefix>/bin/clast without needing a real
...
const (
	// SourceOverride is the user-override directory, $XDG_CONFIG_HOME/clast.
	SourceOverride Source = iota
	// SourceDefault is the shipped default directory, <prefix>/share/clast/assets.
	SourceDefault
...
// OverrideDir returns $XDG_CONFIG_HOME/clast, the user-override directory.
...
// DefaultDir returns <prefix>/share/clast/assets, resolved relative to
// the running executable: the binary is assumed to sit at
// <prefix>/bin/clast, with a sibling <prefix>/share/clast/assets —
...
func DefaultDir() (string, error) {
	...
	prefix := filepath.Dir(filepath.Dir(exe)) // .../bin/clast -> .../bin -> <prefix>
