...
// table verbatim, ported from wip's internal/tiers/remote_test.go
// TestNormalizeRemote_WorkedTable.
...
// TestNormalizeRemote_EdgeCases covers default vs. non-default port, .git
// suffix variants, and mixed-case host. Ported from wip's
// internal/tiers/remote_test.go TestNormalizeRemote_EdgeCases.
...
// normalization: the same repo reached two different ways is one Project.
// Ported from wip's internal/tiers/remote_test.go
// TestNormalizeRemote_TwoInputsSameNormalForm.
...
// TestNormalizeRemote_Rejects confirms an empty, blank, or bare-local-path
// input refuses rather than guessing. Ported from wip's
// internal/tiers/remote_test.go TestNormalizeRemote_Rejects.
